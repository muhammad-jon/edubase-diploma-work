          ...
          <div className="row g-5">
            <div className="col-lg-12">
              <div className="content text-center">
                ...
                <h3 className="title">Vooy... Sahifa topilmadi!</h3>
                <p className="description">
                  Iltimos asosiy sahifaga qayting. Bu yerda hech narsa topilmadi
                </p>
                <div className="backto-home-btn">
                  <Link to="/" className="edu-btn">
                    Asosiy sahifaga qaytish<i className="icon-arrow-right-line-right"></i>
                  </Link>
                </div>
              </div>
            </div>
